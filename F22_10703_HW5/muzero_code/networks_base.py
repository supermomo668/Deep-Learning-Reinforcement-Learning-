...
class InitialModel(Model):
    ...
    def __init__(self, representation_network: Model, value_network: Model,
...
class RecurrentModel(Model):
    ...
    def __init__(self, dynamic_network: Model, reward_network: Model,
...
class BaseNetwork(AbstractNetwork):
    ...
    def __init__(self, representation_network: Model, 
                 value_network: Model, 
                 policy_network: Model, 
                 dynamic_network: Model, 
        ...
        self.initial_model = InitialModel(
            self.representation_network, self.value_network,
            self.policy_network)
        self.recurrent_model = RecurrentModel(
            self.dynamic_network, self.reward_network, self.value_network, 
            self.policy_network)
    ...
    def _value_transform(self, value) -> float:
        print(f"Value transform:{value}")
        pass

    @abstractmethod
    def _reward_transform(self, reward) -> float:
        print(f"Reward transform:{reward}")
        pass
