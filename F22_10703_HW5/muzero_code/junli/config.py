...
class TrainResults(object):
    ...
    def plot_total_loss(self, name=''):
        ...
        plt.ylabel("Loss")
        # plt.show()
        fn = f"./total_loss_{name}.png"
        plt.savefig(fn)

    def plot_individual_losses(self, name=''):
        x_vals = np.arange(len(self.total_losses))
        plt.figure()
        ...
        plt.legend()
        # plt.show()
        fn = f"./individual_losses_{name}.png"
        plt.savefig(fn)

    def plot_policy_loss(self, name=''):
        x_vals = np.arange(len(self.total_losses))
        plt.plot(x_vals, self.policy_losses, label="Policy Loss")
        plt.xlabel("Train Steps")
        plt.ylabel("Losses")
        plt.legend()
        fn = f"./policy_loss_{name}.png"
        plt.savefig(fn)
...
class TestResults(object):
    ...
    def plot_rewards(self):
        ...
        plt.ylabel("Reward")
        # plt.show()
        fn = f"./test_rewards_{self.name}.png"
        plt.savefig(fn)
